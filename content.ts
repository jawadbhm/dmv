    ...
    flashcards: [
      {
        ...
        visual: '🪢',
        visualLabel: 'Control',
        visualStat: 'Push–Pull',
        visualDescriptor: 'Hands glide on the rim; elbows stay low to keep airbags safe.',
        visualTone: 'emerald',
      },
      {
        ...
        visual: '🦶',
        visualLabel: 'Pedal feel',
        visualStat: 'Calm start',
        visualDescriptor: 'Heel anchored; squeeze pedals like dimmers, not switches.',
        visualTone: 'indigo',
      },
      {
        title: 'Backing Up',
        ...
        visual: '🔁',
        visualLabel: 'Reverse',
        visualStat: 'Eyes back',
        visualDescriptor: 'Pivot torso, look through rear glass; cameras confirm only.',
        visualTone: 'amber',
      },
    ],
    checklists: [
    ...
    flashcards: [
      {
        ...
        quickTip: 'If the signal is dark, treat it as an all-way stop until power returns.',
        visualTone: 'indigo',
        visualCue: {
          title: 'Signals',
          metricLabel: 'Dark Signal',
          metricValue: 'Treat as All-Way Stop',
          subtitle: 'Scan all corners; proceed in order of arrival while yielding to peds/bikes.',
          badges: ['Green: Go if clear', 'Yellow: Prepare to stop', 'Red: Stop fully'],
        },
      },
      {
        ...
        quickTip: 'Count a full 2–3 seconds at the line before creeping to see.',
        visualTone: 'rose',
        visualCue: {
          title: 'Stop/Yield',
          metricLabel: 'Full Stop Time',
          metricValue: '2–3 seconds',
          subtitle: 'Stop behind the line/crosswalk, then creep only to see; pedestrians first.',
          badges: ['Yield: let cross traffic clear', 'Right on red only after stop', 'Never block bike box'],
        },
      },
      {
        title: 'Lane Markings',
        ...
        quickTip: 'Plan lane changes before the solid white gore; exiting late risks tickets and crashes.',
        visualTone: 'emerald',
        visualCue: {
          title: 'Markings',
          metricLabel: 'Line Logic',
          metricValue: 'Solid = Stay • Broken = Move',
          subtitle: 'Cross only on broken lines when clear; double solid yellow = no passing.',
          badges: ['No lane changes in intersections', 'Leave bike buffers intact', 'Skip the shoulder/gore'],
        },
      },
      {
        title: 'Crosswalk & Arrow Logic',
        summary: 'Pedestrians win at crosswalks; arrows dictate your lane.',
        dos: ['Yield to peds on flashing hand or solid walk', 'Obey green arrows for protected turns', 'Check for bikes before turning on flashing yellow arrows'],
        donts: ['Block crosswalk stop bars', 'Turn across a bike box on red', 'Jump a flashing yellow without scanning'],
        quickTip: 'Flashing yellow arrow = yield, then turn when pedestrians and bikes are clear.',
        visualTone: 'amber',
        visualCue: {
          title: 'Crosswalks',
          metricLabel: 'Pedestrian Priority',
          metricValue: 'Pedestrians & Bikes First',
          subtitle: 'Walk or flashing hand active? Hold position until crosswalk and bike box clear.',
          badges: ['Green arrow = protected turn', 'Flashing yellow arrow = yield, then go', 'Stay behind stop bar'],
        },
      },
    ],
    checklists: [
