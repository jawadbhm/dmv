    ...
    flashcards: [
      {
        ...
        visual: '🚦',
        visualLabel: 'Signals',
        visualStat: 'Dark = STOP',
        visualDescriptor: 'Power-out? Treat as all-way stop until officers or power return.',
        visualTone: 'indigo',
      },
      {
        ...
        visual: '🛑',
        visualLabel: 'Stop/Yield',
        visualStat: '2–3 sec',
        visualDescriptor: 'Lock a full stop behind the line; then creep only to see.',
        visualTone: 'rose',
      },
      {
        title: 'Lane Markings',
        ...
        visual: '🛣️',
        visualLabel: 'Markings',
        visualStat: 'Solid = Stay',
        visualDescriptor: 'Broken lines = move when clear; solid lines = hold position.',
        visualTone: 'emerald',
      },
      {
        ...
        visual: '🚸',
        visualLabel: 'Crosswalks',
        visualStat: 'Ped first',
        visualDescriptor: 'Walk signal active? Stay put until the crosswalk clears.',
        visualTone: 'amber',
      },
    ],
    checklists: [
